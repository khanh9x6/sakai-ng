    ...
    template: `<p-toast />
        <div class="row row-cols-12 gap-4">
            <div class="col-span-full lg:col-span-6">
                <div class="card">
                    <div class="fw-semibold fs-4 mb-3">Advanced</div>
            ...
            <div class="col-span-full lg:col-span-6">
                <div class="card">
                    <div class="fw-semibold fs-4 mb-3">Basic</div>
                    <div class="d-flex flex-column g-3 align-items-center justify-content-center">
