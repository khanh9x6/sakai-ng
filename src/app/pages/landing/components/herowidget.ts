...
@Component({
    ...
    template: `
        <div
            id="hero"
            class="d-flex flex-column pt-4 px-3 px-lg-5 overflow-hidden"
            style="background: linear-gradient(0deg, rgba(255, 255, 255, 0.2), rgba(255, 255, 255, 0.2)), radial-gradient(77.36% 256.97% at 77.36% 57.52%, rgb(238, 239, 175) 0%, rgb(195, 227, 250) 100%); clip-path: ellipse(150% 87% at 93% 13%)"
        >
            <div class="mx-3 mx-md-5 mt-0 mt-md-4">
                <h1 class="display-3 fw-bold text-dark lh-sm"><span class="fw-light d-block">Eu sem integer</span>eget magna fermentum</h1>
                ...
                <button pButton pRipple [rounded]="true" type="button" label="Get Started" class="fs-5 mt-4 px-3"></button>
            </div>
